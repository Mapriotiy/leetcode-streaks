    ...
    return (
        <main className="min-h-screen bg-transparent p-4 text-white sm:p-6">
                        ...
                        <div className="flex items-center gap-3">
                            {isLeetcodeLinked ? (
                                <div className="hidden items-center gap-1.5 sm:flex">
                                    <span
                                        className={`text-xs ${
                                            isCurrentStreakLit ? "text-[#e07840]" : "text-[#8a8a8a]"
                                        }`}
                                    >
                                        {currentStreakHint}
                                    </span>
                            ...
                            <div className="relative" ref={profileMenuRef}>
                                <button
                                    ...
                                    className="group flex min-w-0 items-center gap-2.5 rounded-md border border-[#4a4a4a] bg-[#333333] px-2.5 py-1.5 text-left transition hover:bg-[#3d3d3d] focus:outline-none focus:ring-2 focus:ring-[#e07840]/30"
                                >
                            ...
                            {user.is_admin && (
                                <button
                                    ...
                                    onClick={onOpenAdmin}
                                    title="Admin panel"
                                    className="grid h-10 w-10 place-items-center rounded-md border border-[#4a4a4a] bg-[#333333] text-[#d7d7d7] transition hover:border-[#e07840]/60 hover:text-[#e07840]"
                                >
                                    <Shield size={18} />
                                </button>
                            )}
            ...
            <div className="mx-auto max-w-5xl">
                    ...
                    <section className="mt-6 rounded-lg border border-[#3a3a3a] bg-[#262626] p-6 shadow-xl shadow-black/20">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <button
                                ...
                                className="inline-flex shrink-0 items-center justify-center gap-2 rounded-md bg-[#e07840] px-4 py-2.5 text-sm font-semibold text-[#111] transition hover:bg-[#ef9a5c]"
                            >
                                <Link2 size={16} />
                                Link LeetCode
                            </button>
                ...
                <section className="mt-6 grid gap-4 sm:grid-cols-3">
                        <article className="flex flex-col rounded-lg border border-[#3a3a3a] bg-[#262626] p-6 shadow-xl shadow-black/20 transition hover:border-[#e07840]/40 hover:shadow-[0_0_35px_-8px_rgba(224,120,64,0.28)]">
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <span className="rounded-full bg-[#333333] px-2.5 py-1 text-xs font-semibold text-[#e07840]">
                                    ...
                                    dashboardData.lobbies.map((lobby) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className="rounded-md border border-[#3a3a3a] bg-[#1f1f1f] px-3 py-2 text-left text-sm transition hover:border-[#e07840]/60 hover:text-[#e07840]"
                                            >
                                                ...
                                                <span className="mt-1 flex items-center justify-between gap-2 text-xs text-[#8a8a8a]">
                                                    ...
                                                    <span className={isActive ? "text-[#e07840]" : "text-[#a3a3a3]"}>
                            ...
                            <div className="mt-auto flex flex-col gap-2">
                                {isLeetcodeLinked ? (
                                    <button
                                        ...
                                        className="mt-4 rounded-md bg-[#e07840] px-4 py-2.5 text-sm font-semibold text-[#111] transition hover:bg-[#ef9a5c]"
                                    >
                                ...
                                {!dashboardData?.today_submissions.length ? (
                                    ...
                                    dashboardData.today_submissions.map((submission) => (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="block rounded-md border px-3 py-2 text-sm text-[#eff1f6] transition hover:border-[#e07840]/60 hover:text-[#e07840]"
                                            style={{
